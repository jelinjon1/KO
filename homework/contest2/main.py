...
def main():
  ...
  # zkusit tohle rozdelit na dve promenne dvourozmerne
  # prirazeni cesty a pak trucku k jednotlive ceste
  # 1
  # z[u, d] = 1 truck d goes to node u
  # y[u] = t arrival time at node u 
  
  '''
  2
  a[u, v] = 1 a truck goes from u to v
  b[u, d] = visits?
  c[u] = t
  s.t.:
